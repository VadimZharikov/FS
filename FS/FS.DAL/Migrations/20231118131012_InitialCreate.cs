    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorEntityFilmEntity", x => new { x.ActorsActorId, x.FilmsFilmId });
                    table.ForeignKey(
                        name: "FK_ActorEntityFilmEntity_Actors_ActorsActorId",
                        column: x => x.ActorsActorId,
                        principalTable: "Actors",
                        principalColumn: "ActorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorEntityFilmEntity_Films_FilmsFilmId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorEntityFilmEntity_FilmsFilmId",
